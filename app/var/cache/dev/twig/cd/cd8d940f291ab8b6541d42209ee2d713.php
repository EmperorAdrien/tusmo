...
class __TwigTemplate_04eda5913b87c0b354259616235819c4 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <form method=\"post\">
        ...
        if (twig_get_attribute($this->env, $this->source, (isset($context["app"]) || array_key_exists("app", $context) ? $context["app"] : (function () { throw new RuntimeError('Variable "app" does not exist.', 20, $this->source); })()), "user", [], "any", false, false, false, 20)) {
            // line 21
            echo "            <div class=\"mb-3\">
                <p class=\"alert\">You are logged in as ";
            // line 22
...
";
    ...
    {
        return array (  177 => 33,  169 => 28,  164 => 25,  156 => 22,  153 => 21,  151 => 20,  148 => 19,  142 => 17,  140 => 16,  136 => 14,  126 => 13,  107 => 11,  94 => 8,  84 => 7,  71 => 4,  61 => 3,  38 => 1,);
    }
...
<div class=\"container\">
    <form method=\"post\">
        ...
        {% if app.user %}
            <div class=\"mb-3\">
                <p class=\"alert\">You are logged in as {{ app.user.userIdentifier }}, <a href=\"{{ path('app_logout') }}\">Logout</a></p>
            </div>
        {% endif %}
