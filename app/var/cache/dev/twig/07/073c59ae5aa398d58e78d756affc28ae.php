...
class __TwigTemplate_b54273d5de98e27157f93615c61f63be extends Template
{
    private $source;
    private $macros = [];
...
Symfony Twig Bridge to ensure that all applications building backends with EasyAdmin
use the same version of the templates, even those still using Symfony 4.4.
", "@EasyAdmin/symfony-form-themes/README.txt", "/var/www/vendor/easycorp/easyadmin-bundle/src/Resources/views/symfony-form-themes/README.txt");
    }
}
